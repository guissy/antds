...
export default () => {
  const [mode, setMode] = createSignal<MenuProps['mode']>('horizontal');
  const [narrow, setNarrow] = createSignal(false);
  const [inlineCollapsed, setInlineCollapsed] = createSignal(false);
    ...
    <>
      ...
      <div style={{ width: narrow() ? '350px' : '' }}>
        <Menu
          ...
          mode={mode()}
          style={{ width: mode() === 'horizontal' ? undefined : '256px' }}
          onClick={onRootClick}
